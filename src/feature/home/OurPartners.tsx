  ...
  return (
    <div className="flex pt-16 pb-20 flex-col items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 w-fit pt-9 md:pt-11">
        <div className="w-29 md:w-63 h-13 md:h-29 rounded-sm p-0.5 bg-black-gradient flex items-center justify-center">
          <div className="w-full h-full bg-grey-50 rounded-xs flex items-center justify-center">
            <img
              src="/partners/partner_1.svg"
              className="h-10 md:h-23 object-cover"
              alt="partner"
            />
          </div>
        </div>

        <div className="w-29 md:w-63 h-13 md:h-29  rounded-sm p-0.5 bg-blue-gradient flex items-center justify-center">
        ...
        <div className="w-29 md:w-63 h-13 md:h-29 rounded-sm p-0.5 bg-orange-gradient flex items-center justify-center">
